...
def trace_tail_value (fn_name : String) (arity : I64) (defs : HashMap String LLVMValue) (v : LLVMValue) (owning_label : String) : List SelfTailCallSite :=
    match v {
        ...
        LLVMValue.bitcast _v2 _f _t => List.empty,
        LLVMValue.sext _v2 _f _t => List.empty,
        LLVMValue.typed _v2 _t => List.empty,
...
def rewrite_parm_to_loopvar (v : LLVMValue) (loop_names : List String) : LLVMValue :=
    match v {
        ...
        LLVMValue.and_ a b => LLVMValue.and_ (rewrite_parm_to_loopvar a loop_names) (rewrite_parm_to_loopvar b loop_names),
        LLVMValue.or_ a b => LLVMValue.or_ (rewrite_parm_to_loopvar a loop_names) (rewrite_parm_to_loopvar b loop_names),
        LLVMValue.xor_ a b => LLVMValue.xor_ (rewrite_parm_to_loopvar a loop_names) (rewrite_parm_to_loopvar b loop_names),
        LLVMValue.shl_ a b => LLVMValue.shl_ (rewrite_parm_to_loopvar a loop_names) (rewrite_parm_to_loopvar b loop_names),
        LLVMValue.lshr_ a b => LLVMValue.lshr_ (rewrite_parm_to_loopvar a loop_names) (rewrite_parm_to_loopvar b loop_names),
        ...
        LLVMValue.bitcast val from_ty to_ty => LLVMValue.bitcast (rewrite_parm_to_loopvar val loop_names) from_ty to_ty,
        LLVMValue.sext val from_ty to_ty => LLVMValue.sext (rewrite_parm_to_loopvar val loop_names) from_ty to_ty,
        LLVMValue.typed val ty => LLVMValue.typed (rewrite_parm_to_loopvar val loop_names) ty,
        ...
        match i {
            LLVMInstruction.assign target value =>
                match value {
                    ...
                    LLVMValue.bitcast _v2 _f _t => prune_phi_in_instrs_rest i rest stale_label,
                    LLVMValue.sext _v2 _f _t => prune_phi_in_instrs_rest i rest stale_label,
                    LLVMValue.typed _v2 _t => prune_phi_in_instrs_rest i rest stale_label,
