...
pub def Bench.now : IO I64 := current_time
...
pub def Bench.report (label : String) (elapsed_ms : I64) : IO Unit :=
...
pub def Bench.since (t0 : I64) : IO I64 := do {
...
pub def Bench.report_since (label : String) (t0 : I64) : IO Unit := do {
